			...
			<section>
				<div>
					...
					<section class="c-infor-tabTitle c-tab-title cnew-tab-title">
						<a href="${ctx }javascript: void(0)" title="我的问答" style="cursor: default;">我的问答</a>
						<a href="${ctx }/uc/myquestions/list" title="我的提问">我的提问</a>
						<a href="${ctx }/uc/myrepquestions/list" title="我的回答" class="current">我的回答</a>
					</section>
				</div>
				<div class="mt40">
