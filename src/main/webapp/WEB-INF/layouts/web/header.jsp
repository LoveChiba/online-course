			...
			<ul>
				<li>
					...
					<ol>
						...
						<li><a href="javascript:void(0)" onclick="mobileHrefCheckLogin('${ctx }/uc/myFavorites')" title="">我的收藏</a></li>
					</ol>
				</li>
			</ul>
			<ul>
				<li>
					<span>问答中心</span>
					<ol>
						<li><a href="javascript:void(0)" onclick="mobileHrefCheckLogin('${ctx }/uc/myquestions/list')" title="">我的提问</a></li>
						<li><a href="javascript:void(0)" onclick="mobileHrefCheckLogin('${ctx }/uc/myrepquestions/list')" title="">我的回答</a></li>
					</ol>
				</li>
			</ul>
			<ul>
